...
/** 157 sequential user+wallet+billing writes; needs headroom under full-suite worker load. */
const BULK_IMPORT_STRESS_TIMEOUT_MS = 60_000;
...
describe("Bulk Import Limit Reproduction", () => {
    ...
    it(
        "should handle 157 members without exceeding parameter limit",
        async () => {
