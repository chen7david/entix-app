...
import { getImageUrl, getAvatarUrl, getAssetUrl } from "../../shared/utils/image-url";
...
describe("image-url utilities", () => {
    ...
    it("builds Cloudflare transformation URL when enabled", () => {
        const url = getImageUrl("https://cdn.entix.org/orgId/file.png", { width: 100, height: 100 }, true);
    ...
    it("uses avatar presets and applies transformations when env var is set", () => {
        ...
        expect(largeAvatar).toBe("https://cdn.entix.org/cdn-cgi/image/width=200,height=200,fit=cover/orgId/file.png");
    });
