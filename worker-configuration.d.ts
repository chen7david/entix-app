/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings --env development` (hash: 457444d3399a33fdfb37b783e4ba3158)
// Runtime types generated with workerd@1.20260401.1 2025-12-10 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./api/main");
	}
	interface Env {
		...
		OPENWEBUI_MODEL: "gemma4:e4b";
		OPENWEBUI_ENDPOINT: "https://ai.entix.org/api/chat/completions";
		SKIP_EMAIL_VERIFICATION: "false";
		CLOUDFLARE_D1_LOCAL_DB: string;
		BETTER_AUTH_SECRET: string;
		RESEND_API_KEY: string;
		R2_SECRET_ACCESS_KEY: string;
		CLOUDFLARE_API_TOKEN: string;
		SKIP_AUTH_EMAILS: string;
		INTERNAL_SECRET: string;
		OPEN_WEB_UI_API_KEY: string;
		OPEN_WEB_UI_MODEL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FRONTEND_URL" | "CORS_ORIGINS" | "CLOUDFLARE_ACCOUNT_ID" | "R2_BUCKET_NAME" | "R2_ACCESS_KEY_ID" | "PUBLIC_CDN_URL" | "OPENWEBUI_MODEL" | "OPENWEBUI_ENDPOINT" | "SKIP_EMAIL_VERIFICATION" | "CLOUDFLARE_D1_LOCAL_DB" | "BETTER_AUTH_SECRET" | "RESEND_API_KEY" | "R2_SECRET_ACCESS_KEY" | "CLOUDFLARE_API_TOKEN" | "SKIP_AUTH_EMAILS" | "INTERNAL_SECRET" | "OPEN_WEB_UI_API_KEY" | "OPEN_WEB_UI_MODEL" | "REALTIME_KIT_APP_ID" | "REALTIME_KIT_PRESET_ORGANIZER" | "REALTIME_KIT_PRESET_PARTICIPANT">> {}
}
