...
export const MemberRolesForm = ({
    ...
    const memberRoles = String(member.role || "")
        .split(",")
        .map((r) => r.trim())
        .filter(Boolean);
        ...
        <div className="flex flex-col gap-4 pt-2">
                ...
                {canEdit ? (
                    ...
                    <Text type="secondary">
                        {isSelf
                            ...
                            : "You do not have permission to change this member's roles."}
                    </Text>
                )}
            </Card>
            ...
            {canDeleteMember && !isSelf && (
                <Card
                    size="small"
                    title="Danger Zone"
                    className="border-red-200 dark:border-red-900 shadow-sm"
                >
                    ...
                    <Popconfirm
                        ...
                        onConfirm={() =>
                            handleRemoveMember(member.id as string).then(() => onRemoveSuccess?.())
                        }
                        okText="Yes"
                        cancelText="No"
