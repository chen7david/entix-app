...
export class UserAvatarRoutes {
    ...
    static requestAvatarUploadUrl = createRoute({
        ...
        middleware: [requirePermission("avatar", ["create"], "userId")] as const,
        request: {
            params: z.object({
                userId: z.string(),
            }),
    ...
    static updateAvatar = createRoute({
        ...
        middleware: [requirePermission("avatar", ["update"], "userId")] as const,
        request: {
            params: z.object({
                userId: z.string(),
            }),
    ...
    static removeAvatar = createRoute({
        ...
        path: "/users/{userId}/avatar",
        middleware: [requirePermission("avatar", ["delete"], "userId")] as const,
        request: {
            params: z.object({
                userId: z.string(),
            }),
