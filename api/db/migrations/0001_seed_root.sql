...
INSERT OR IGNORE INTO `auth_users` (`id`, `name`, `email`, `email_verified`, `role`, `created_at`, `updated_at`, `banned`)
VALUES ('TiD38FfFP9TXbiDAdin6hi5oZjJzu3UK', 'Root Admin', 'root@admin.com', 1, 'admin', (cast(unixepoch('subsecond') * 1000 as integer)), (cast(unixepoch('subsecond') * 1000 as integer)), 0);
